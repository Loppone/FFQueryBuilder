...
{
    public partial class FrnVistaRasComunicazioniDaInviareUtentiBo
    {
        public string UtenteBackOffice { get; set; }
        public string DataRichiestaClienteIntegrazioneRasStr { get; set; }
        public string DataIntegrRichAutStr { get; set; }
        public DateTime? DataInvioRasInvioSap { get; set; }
        public DateTime? DataInvioCapogruppoInvioSap { get; set; }
        public DateTime? DataInvioRasDateTime { get; set; }
        public DateTime? DataInvioCapogruppoDateTime { get; set; }
        public string DataAutorizzazioneSubappalto { get; set; }
        public string DataAutorizzazioneSubappaltosStr { get; set; }
        public bool? Capogruppo { get; set; }
        public string DescrizioneCapogruppo { get; set; }
        public string CodiceRda { get; set; }
        public string OkDocumenti { get; set; }
        public string DataInvioRasRda { get; set; }
        public string DataInvioCapoGruppo { get; set; }
        ...
        public string DescrizioneCommessaLivello1 { get; set; }
